...
- **Directory**: `Knowledge/Uncategorized`
- **Files to link**: 4
- **Sample files**:
  - [[Knowledge/Uncategorized/객체지향_패러다임.md|객체지향 패러다임]]
  - [[Knowledge/Uncategorized/Jira_개념.md|Jira 개념]]
  - [[Knowledge/Uncategorized/예시.md|예시]]
  - [[Knowledge/Uncategorized/Hadoop.md|Hadoop]]

### Concepts-Hub.md

- **Directory**: `Knowledge/Analytics/Web-Analytics/Concepts`
- **Files to link**: 3
- **Sample files**:
  - [[Knowledge/Analytics/Web-Analytics/Concepts/웹로그_분석_과정.md|웹로그 분석 과정]]
  - [[Knowledge/Analytics/Web-Analytics/Concepts/WEB3.md|WEB3]]
  - [[Knowledge/Analytics/Web-Analytics/Concepts/웹로그관련_기초_용어.md|웹로그관련 기초 용어]]

### Learning-Path-Hub.md

- **Directory**: `Knowledge/Professional-Development/Learning-Path`
- **Files to link**: 3
- **Sample files**:
  - [[Knowledge/Professional-Development/Learning-Path/AI_보조_코딩이_소프트웨어_엔지니어링을_어떻게_바꿀_것인가_불편한_진실__GeekNews.md|AI 보조 코딩이 소프트웨어 엔지니어링을 어떻게 바꿀 것인가: 불편한 진실 | GeekNews]]
  - [[Knowledge/Professional-Development/Learning-Path/커리어_패스_설계.md|커리어 패스 설계]]
  - [[Knowledge/Professional-Development/Learning-Path/Nginx_학습.md|Nginx 학습]]

### Certifications-Hub.md

- **Directory**: `Knowledge/Professional-Development/Certifications`
- **Files to link**: 3
- **Sample files**:
  - [[Knowledge/Professional-Development/Certifications/1과목.md|1과목]]
  - [[Knowledge/Professional-Development/Certifications/3과목.md|3과목]]
  - [[Knowledge/Professional-Development/Certifications/2과목.md|2과목]]

### Concepts-Hub.md

- **Directory**: `Knowledge/Data-Management/Data-Governance/Concepts`
- **Files to link**: 3
- **Sample files**:
...
- **Directory**: `Knowledge/Technology/Infrastructure/AWS/Concepts`
- **Files to link**: 5
- **Sample files**:
  - [[Knowledge/Technology/Infrastructure/AWS/Concepts/personalize.md|personalize]]
  - [[Knowledge/Technology/Infrastructure/AWS/Concepts/lambda_개념.md|lambda 개념]]
  - [[Knowledge/Technology/Infrastructure/AWS/Concepts/filter,_pivot_table,_round_사용.md|filter, pivot_table, round 사용]]
  - [[Knowledge/Technology/Infrastructure/AWS/Concepts/lambda_db_connection_관리.md|lambda db connection 관리]]
  - [[Knowledge/Technology/Infrastructure/AWS/Concepts/직방_SQS_+_lambda.md|직방 SQS + lambda]]

### Patterns-Hub.md

- **Directory**: `Knowledge/Technology/Infrastructure/Docker/Patterns`
- **Files to link**: 4
- **Sample files**:
  - [[Knowledge/Technology/Infrastructure/Docker/Patterns/Docker_실습.md|Docker 실습]]
  - [[Knowledge/Technology/Infrastructure/Docker/Patterns/Jenkins_시행착오.md|Jenkins 시행착오]]
  - [[Knowledge/Technology/Infrastructure/Docker/Patterns/docker_image_작성.md|docker image 작성]]
  - [[Knowledge/Technology/Infrastructure/Docker/Patterns/고급_기능_가이드.md|고급 기능 가이드]]

### Patterns-Hub.md

- **Directory**: `Knowledge/Technology/Orchestration/Patterns`
- **Files to link**: 7
- **Sample files**:
  - [[Knowledge/Technology/Orchestration/Patterns/airflow_3.0.md|airflow 3.0]]
  - [[Knowledge/Technology/Orchestration/Patterns/TypeB_CRM_서비스_구축.md|TypeB CRM 서비스 구축]]
  - [[Knowledge/Technology/Orchestration/Patterns/keycloak으로_Dag_권한관리.md|keycloak으로 Dag 권한관리]]
  - [[Knowledge/Technology/Orchestration/Patterns/Rules_for_good_dags.md|Rules for good dags]]
  - [[Knowledge/Technology/Orchestration/Patterns/요기요_airflow_dag_code.md|요기요 airflow dag code]]

### Concepts-Hub.md

- **Directory**: `Knowledge/Technology/Orchestration/Concepts`
- **Files to link**: 14
- **Sample files**:
  - [[Knowledge/Technology/Orchestration/Concepts/기존_서비스와_연결(airflow,_postgresql).md|기존 서비스와 연결(airflow, postgresql)]]
  - [[Knowledge/Technology/Orchestration/Concepts/logs_s3_연결_.md|logs s3 연결]]
